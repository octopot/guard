...
func request_Maintenance_Install_0(ctx context.Context, marshaler runtime.Marshaler, client MaintenanceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterMaintenanceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MaintenanceClient) error {
	...
	mux.Handle("POST", pattern_Maintenance_Install_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Maintenance_Install_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Maintenance_Install_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	forward_Maintenance_Install_0 = runtime.ForwardResponseMessage
)
