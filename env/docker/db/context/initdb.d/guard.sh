...
psql -v ON_ERROR_STOP=1 --username "${POSTGRES_USER}" <<-EOSQL
    ...
    VALUES ('10000000-2000-4000-8000-160000000002', '10000000-2000-4000-8000-160000000001');

    INSERT INTO "license_employee" ("license", "employee")
    VALUES ('10000000-2000-4000-8000-160000000003', '10000000-2000-4000-8000-160000000004');
EOSQL
